...
//        testAddRandom();
    ...
    public static void testSearch() {
        System.out.println("=== Search Test start ===");
    ...
    public static void testAddRandom() {
        System.out.println("=== Add Random Test start ===");
        int n = 10000000;
    ...
    public static void testAddSequence() {
        System.out.println("=== Add Sequence Test start ===");
        int n = 50000000;
        ...
        System.out.println("=== Add Sequence Test end ===");
    }
